...
for c in C_iter:
    ...
    X, y, id_groups = pre_process_group_classify_connect(df, connect_name)
    ...
    pain_final_performance_log_file = open('concussion_perform_select_log_{}_{}.pkl'.format(c, connect_name), 'ab')
...
for c in C_iter:
    for k in kernel:
        ...
        pain_final_performance_svm_file = open('concussion_perform_select_svm_{}_{}_{}.pkl'.format(c, k, connect_name), 'ab')
...
for cr in Crit:
    ...
    pain_final_performance_tree_file = open('concussion_perform_select_tree_{}_{}.pkl'.format(cr, connect_name), 'ab')
...
pain_final_performance_lda_file = open("concussion_perform_select_lda_%s.pkl" % connect_name, 'ab')
